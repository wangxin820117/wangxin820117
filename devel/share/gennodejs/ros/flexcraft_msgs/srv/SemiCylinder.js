...
class SemiCylinderRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SemiCylinderRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SemiCylinderRequest
    let len;
    let data = new SemiCylinderRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SemiCylinderRequest(null);
...
class SemiCylinderResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SemiCylinderResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SemiCylinderResponse
    let len;
    let data = new SemiCylinderResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'flexcraft_msgs/SemiCylinderResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SemiCylinderResponse(null);
...
module.exports = {
  Request: SemiCylinderRequest,
  Response: SemiCylinderResponse,
  md5sum() { return 'f53643562a419117971ff923d0858358'; },
  datatype() { return 'flexcraft_msgs/SemiCylinder'; }
};
