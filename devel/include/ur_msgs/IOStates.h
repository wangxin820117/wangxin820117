...
struct Printer< ::ur_msgs::IOStates_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_msgs::IOStates_<ContainerAllocator>& v)
  {
    if (false || !indent.empty())
      s << std::endl;
    s << indent << "digital_in_states: ";
    if (v.digital_in_states.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.digital_in_states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ur_msgs::Digital_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.digital_in_states[i]);
    }
    if (v.digital_in_states.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "digital_out_states: ";
    if (v.digital_out_states.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.digital_out_states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ur_msgs::Digital_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.digital_out_states[i]);
    }
    if (v.digital_out_states.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "flag_states: ";
    if (v.flag_states.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.flag_states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ur_msgs::Digital_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.flag_states[i]);
    }
    if (v.flag_states.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "analog_in_states: ";
    if (v.analog_in_states.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.analog_in_states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ur_msgs::Analog_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.analog_in_states[i]);
    }
    if (v.analog_in_states.empty() || false)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "analog_out_states: ";
    if (v.analog_out_states.empty() || false)
      s << "[";
    for (size_t i = 0; i < v.analog_out_states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::ur_msgs::Analog_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.analog_out_states[i]);
    }
    if (v.analog_out_states.empty() || false)
      s << "]";
  }
